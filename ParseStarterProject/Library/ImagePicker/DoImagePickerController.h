...
#define DO_MENU_BACK_COLOR          DO_RGBA(215, 215, 215, 0.98)
#define DO_SIDE_BUTTON_COLOR        DO_RGBA(215, 215, 215, 0.9)

#define DO_ALBUM_NAME_TEXT_COLOR    DO_RGB(215, 215, 215)
#define DO_ALBUM_COUNT_TEXT_COLOR   DO_RGB(215, 215, 215)
#define DO_BOTTOM_TEXT_COLOR        DO_RGB(215, 215, 215)
