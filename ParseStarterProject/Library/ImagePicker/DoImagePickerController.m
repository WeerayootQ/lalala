...
- (void)initBottomMenu
{
    ...
    _btSelectAlbum.titleLabel.font = FONT_REG(18);
    _btSelectAlbum.titleLabel.textColor = DO_ALBUM_NAME_TEXT_COLOR;
//    [_btSelectAlbum setTitleColor:DO_ALBUM_NAME_TEXT_COLOR forState:UIControlStateNormal];
