...
- (void)showAtPoint:(CGPoint)point inView:(UIView *)view withText:(NSString *)text
{
    ...
    CGRect textSize = [attributedText boundingRectWithSize:CGSizeMake(screenSize.width - kHorizontalMargin*4.f, 1000.f)
...
//    CGSize textSize = [text sizeWithFont:font constrainedToSize:CGSizeMake(screenSize.width - kHorizontalMargin*4.f, 1000.f) lineBreakMode:NSLineBreakByWordWrapping];
    ...
    UILabel *textView = [[UILabel alloc] initWithFrame:CGRectMake(0, 0, textSize.size.width, textSize.size.height)];
...
- (void)showAtPoint:(CGPoint)point inView:(UIView *)view withTitle:(NSString *)title withViewArray:(NSArray *)viewArray
{
    ...
    UILabel *titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(0.f, 0.f, /*titleSize.width*/ 320, titleSize.height)];
    ...
    container.frame = CGRectMake(0, 0, 320, totalHeight);//CGRectMake(0, 0, totalWidth, totalHeight);
...
- (void)showAtPoint:(CGPoint)point inView:(UIView *)view withTitle:(NSString *)title withStringArray:(NSArray *)stringArray
 {
    ...
    for (NSString *string in stringArray) {
        CGSize textSize = [string sizeWithFont:font];
        UIButton *textButton = [[UIButton alloc] initWithFrame:CGRectMake(-10, 0, /*textSize.width*/ 320, textSize.height)];
        textButton.backgroundColor = [UIColor clearColor];
        textButton.titleLabel.font = font;
        textButton.titleLabel.textAlignment = kTextAlignment;
        textButton.titleLabel.textColor = kTextColor;
...
//    if (topPoint.y - contentHeight - arrowHeight - topPadding < CGRectGetMinY(topViewBounds)) {
        ...
        boxFrame = CGRectMake(0, arrowPoint.y + arrowHeight, boxWidth, boxHeight);//CGRectMake(xOrigin, arrowPoint.y + arrowHeight, boxWidth, boxHeight);
//    } else {
//        //Position above.
//        above = YES;
//        
//        boxFrame = CGRectMake(0, arrowPoint.y - arrowHeight - boxHeight, boxWidth, boxHeight);//CGRectMake(xOrigin, arrowPoint.y - arrowHeight - boxHeight, boxWidth, boxHeight);
//    }
